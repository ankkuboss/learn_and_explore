...
*/
 $config['auth_override_class_method_http']['auth']['*'] = 'none';
 $config['auth_override_class_method_http']['store_offer']['get_store_list'] = 'none';
 $config['auth_override_class_method_http']['store_offer']['get_store_offers'] = 'none';
 $config['auth_override_class_method_http']['store_offer']['get_banner_list'] = 'none';
 $config['auth_override_class_method_http']['my_profile']['logout'] = 'none';
// ---Uncomment list line for the wildard unit test
