angular.module("learn_and_explore").controller('storeOfferCtrl',storeOfferCtrl );


storeOfferCtrl.$inject = ['$scope', 'commonService', '$state', '$rootScope']

function storeOfferCtrl($scope, commonService, $state, $rootScope) {
