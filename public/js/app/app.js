...
app.config(['$stateProvider', '$locationProvider', '$httpProvider', '$urlRouterProvider', '$ocLazyLoadProvider', 'ScrollBarsProvider', function($stateProvider, $locationProvider, $httpProvider, $urlRouterProvider, $ocLazyLoadProvider, $ScrollBarsProvider) {
	...
	.state('home',{
		url:'/',
		cache: true, //required
		templateUrl: site_url+'public/templates/home/home.html',
		data: {pageTitle:language.SITE_HOME, routename:'home',meta_desc:'home_meta_desc'
		//,lang:['auth.js']
	},
	...
	.state('signup',{
		url:'/signup',
		templateUrl:site_url+'public/templates/home/signup.html',
		data: {pageTitle:'Signup',routename:'signup'
		//, lang:['signup.js']
	},
		controller:'LoginCtrl',
		resolve:{
	...
	.state('storeDetails',{
		url:'/store_details/:store_id',
		templateUrl:site_url+'public/templates/store/store_details.html',
		data: {pageTitle:'store details',routename:'storeDetails'
		//, lang:['signup.js']
	},
			...
			deps: ['$ocLazyLoad', function($ocLazyLoad) {
				return $ocLazyLoad.load([{
					...
					files: [
						'public/js/lib/validate.min.js',
						//'assets/js/lib/select2.full.min.js',
						'public/js/app/controller/storeCtrl.js'
					]
				}]);
			}]
		},
	...
	.state('my_profile',{
		url:'/my_profile',
		templateUrl:site_url+'public/templates/home/my_profile.html',
		data: {pageTitle:'My Profile',routename:'my_profile'
		//, lang:['signup.js']
	},
		controller:'userCtrl',
		resolve:{
	...
	.state('earnings',{
		url:'/my_earnings',
		templateUrl:site_url+'public/templates/home/my_earnings.html',
		data: {pageTitle:'My Earnings',routename:'earnings'
		//, lang:['signup.js']
	},
			...
			deps: ['$ocLazyLoad', function($ocLazyLoad) {
				return $ocLazyLoad.load([{
					...
					files: [
						'public/js/lib/validate.min.js',
						//'assets/js/lib/select2.full.min.js',
						'public/js/app/controller/earningCtrl.js'
					]
				}]);
			}]
		},
